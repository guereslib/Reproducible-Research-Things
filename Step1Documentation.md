...
Documentation will also be important for any audits in your lab or if someone would like to reproduce your research.
 ...
 Beginner | Start with documenting in a text file the following  * Where files are stored  * Any safety documentation  * Where lab protocols, code or workflow information is stored or what programs you use to create your working files  * where the raw data was originally from  Have this document automatically synced to the cloud
